package com.example.day__.topnews;
...
public class MainActor {
    ...
    public void NewsApplication(String source1,String source2,String source3){
        ...
        String URL ="https://newsapi.org/v2/top-headlines?sources="+source1+","+source2+","+source3+"&apiKey=d81e5fd7ee804b1fa15787f74b8b4093";
